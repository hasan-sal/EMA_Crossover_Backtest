...
fast_ema_range = range(5, 41, 1)
slow_ema_range = range(41, 101, 1)
atr_range = range(5, 21, 1)
in_sample_start_date = "2010-01-01"
in_sample_end_date = "2017-01-01"
out_of_sample_start_date = "2017-01-01"
...
for fast_ema in fast_ema_range:
    for slow_ema in slow_ema_range:
        ...
        for atr_period in atr_range:
            total_gain, compound_annual_growth_rate, total_trades, portfolio_values = backtest.backtest_strategy(data.TICKER, in_sample_start_date, in_sample_end_date, fast_ema, slow_ema, atr_period, raw_data)
...
print(results_df.sort_values(by="compound_annual_growth_rate", ascending=False).head(10))
